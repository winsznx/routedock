...
mod tests {
    ...
    fn setup(env: &Env) -> (AgentVaultClient<'_>, SigningKey, Address, Address) {
        ...
        // daily_cap = 5_000_000 stroops (0.50 USDC), expiry = ledger 10_000, no lifetime cap
    ...
    /// Test 14: lifetime cap of 0 means unlimited — large spend across days is accepted.
    #[test]
    ...
    /// Test 15: lifetime cap enforced — transfer exceeding lifetime cap rejected.
    #[test]
    ...
    /// Test 16: lifetime cap boundary — spending exactly at cap succeeds.
    #[test]
    ...
    /// Test 17: lifetime cap boundary — one stroop over limit fails.
    #[test]
    ...
    /// Test 18: lifetime spend accumulates across day resets.
    #[test]
    ...
    /// Test 19: get_lifetime_spend returns the monotonic counter correctly.
    #[test]
    ...
    /// Test 20: daily cap rejection does NOT advance lifetime spend counter.
    #[test]
